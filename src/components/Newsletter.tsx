      ...
      <div className='max-w-[1240px] mx-auto grid lg:grid-cols-3'>
        ...
        <div className="my-4">
            <div className="flex flex-col sm:flex-row items-center justify-between w-full">
                ...
                <button className="w-[200px] rounded-md font-semibold my-7 mx-auto py-4 hover:bg-cyan-600 duration-300 text-white bg-cyan-400 ml-4 px-6 sm:items-center">Notify Me</button>
            </div>
